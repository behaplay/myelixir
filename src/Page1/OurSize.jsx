            ...
            <div className="flex flex-col sm:gap-2 md:gap-0 bg-white rounded-3xl lg:w-[1108px]">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center gap-12">
                    ...
                    <div className="animate-fade-up duration-300 flex flex-col text-center sm:text-start items-center sm:items-start mx-10 mb-5 gap-6 lg:w-[380px]">
                        ...
                        <p className="text-[14px] md:text-[16px] text-gray-500 font-opens w-[90%] lg:w-[458px]">As one of the world’s largest accountancy networks, elixir helps a diverse range of clients with a diverse range of needs.This is especially true of our Advisory Practice, which provides corporate finance and transaction services, business restructuring.</p>
                ...
                <div className="flex flex-col lg:flex-row-reverse lg:items-center gap-12">
                    ...
                    <div className="animate-fade-up duration-300 flex flex-col text-center sm:text-start items-center sm:items-start mx-10 mb-5 gap-6 lg:w-[380px]">
                        ...
                        <p className="text-[14px] md:text-[16px] text-gray-500 font-opens w-[90%] lg:w-[458px]">Elixir serves clients across the country and around the world as they navigate an increasingly complex tax landscape. Our tax professionals draw on deep experience and industry-specific knowledge to deliver clients the insights and innovation they need.</p>
                        <span className="text-[16px] font-opens text-center lg:text-start font-bold hover:underline text-blue-900">Learn More&#8594;</span>
                    </div>
                </div>
                <div className="flex flex-col lg:flex-row lg:items-center gap-12">
                    ...
                    <div className=" animate-fade-up duration-300 flex flex-col text-center sm:text-start items-center sm:items-start mx-10 mb-5 gap-6 lg:w-[380px]">
                        ...
                        <p className="text-[14px] md:text-[16px] text-gray-500 font-opens w-[90%] lg:w-[458px]">To help you understand what this road looks like, we surveyed 1165 digital marketers across Europe and North America to explore current trends and priorities in digital marketing.</p>
                        <span className="text-[16px] font-opens text-center lg:text-start font-bold hover:underline text-blue-900">Learn More&#8594;</span>
                    </div>
                </div>
            </div>
